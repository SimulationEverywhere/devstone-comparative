#ifndef _DevStoneTrigger_h_
#define _DevStoneTrigger_h_
...
class DevStoneTrigger: public adevs::Atomic<PortValue> {
protected:
	std::string name;
	double sigma;
...
public:
    ...
    DevStoneTrigger(const std::string name, double preparationTime, double period, long maxEvents) : adevs::Atomic<PortValue>() {
        this->name = name;
...
const int DevStoneTrigger::out(0);
